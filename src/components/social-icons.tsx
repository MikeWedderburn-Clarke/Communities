...
export function SocialIcons({ facebook, instagram, website, youtube }: SocialLinksProps) {
  const links = [
    facebook && { href: facebook, icon: <FacebookIcon />, label: "Facebook" },
    instagram && { href: instagram, icon: <InstagramIcon />, label: "Instagram" },
    website && { href: website, icon: <WebsiteIcon />, label: "Website" },
    youtube && { href: youtube, icon: <YouTubeIcon />, label: "YouTube" },
...
function InstagramIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="#E4405F" aria-hidden="true">
