...
describe("buildLocationHierarchy", () => {
  ...
  it("groups a single event into one country, one city, one venue", () => {
    const events = [makeEvent({ id: "e1", location: "Park", country: "UK", city: "London" })];
  ...
  it("groups multiple events at the same venue", () => {
    const events = [
      makeEvent({ id: "e1", location: "Park", country: "UK", city: "London" }),
      makeEvent({ id: "e2", location: "Park", country: "UK", city: "London" }),
    ];
    const result = buildLocationHierarchy(events);
  ...
  it("groups multiple venues in one city", () => {
    const events = [
      makeEvent({ id: "e1", location: "Park A", country: "UK", city: "London" }),
      makeEvent({ id: "e2", location: "Park B", country: "UK", city: "London" }),
    ];
    const result = buildLocationHierarchy(events);
  ...
  it("groups multiple cities under one country", () => {
    const events = [
      makeEvent({ id: "e1", country: "UK", city: "London", location: "V1" }),
      makeEvent({ id: "e2", country: "UK", city: "Manchester", location: "V2" }),
    ];
    const result = buildLocationHierarchy(events);
  ...
  it("groups multiple countries", () => {
    const events = [
      makeEvent({ id: "e1", country: "UK", city: "London", location: "V1" }),
      makeEvent({ id: "e2", country: "France", city: "Paris", location: "V2" }),
    ];
    const result = buildLocationHierarchy(events);
  ...
  it("sorts alphabetically at all levels", () => {
    const events = [
      makeEvent({ id: "e1", country: "UK", city: "Manchester", location: "Zulu Gym" }),
      makeEvent({ id: "e2", country: "France", city: "Paris", location: "Alpha Centre" }),
      makeEvent({ id: "e3", country: "UK", city: "London", location: "Beta Park" }),
      makeEvent({ id: "e4", country: "UK", city: "London", location: "Alpha Park" }),
    ];
    const result = buildLocationHierarchy(events);
  ...
  it("sorts events within a venue by dateTime", () => {
    const events = [
      makeEvent({ id: "e2", dateTime: "2026-03-02T10:00:00Z", location: "Park", country: "UK", city: "London" }),
      makeEvent({ id: "e1", dateTime: "2026-03-01T10:00:00Z", location: "Park", country: "UK", city: "London" }),
    ];
    const result = buildLocationHierarchy(events);
